...
import { InternshipApplicationResponseDto, CreateInternshipApplicationDto, UpdateInternshipApplicationDto } from './internship.dto';
import { InternshipStatus } from './internship.entity';
...
export class InternshipApplicationController {
  ...
  @Post()
  @ApiOperation({ summary: 'Apply for internship (Public)' })
  @ApiResponse({
    status: HttpStatus.CREATED,
    description: 'Application submitted successfully',
    type: InternshipApplicationResponseDto,
  })
  async createApplication(@Body() createDto: CreateInternshipApplicationDto) {
  ...
  @ApiQuery({ name: 'status', required: false, enum: InternshipStatus })
  ...
  async updateApplication(
    ...
    @Body() updateDto: UpdateInternshipApplicationDto,
  ) {
